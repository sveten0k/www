...
function make_request($request_xml, &$arrMessage, $code) {
  $opts = [
	...
	//$fp = fopen('http://php3/php-3-files/demo/xml-rpc/server.php', 'r', false, $context);
	//$retval = stream_get_contents($fp);
	$retval = file_get_contents('http://php3/php-3-files/demo/xml-rpc/server.php', false, $context);
